...
import { Search, Filter, ShoppingCart, MapPin, Loader2, Plus, Edit, Trash2 } from 'lucide-react';
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-8">
        <div>
          ...
          <p className="text-gray-600 mt-2">
            Buy fresh produce directly from farmers across India
          </p>
        </div>
        {user?.role === 'farmer' && (
          <Link
          ...
          {products.map((product) => (
            ...
            >
              ...
              <div className="p-4">
                ...
                {/* Edit/Delete buttons for farmer's own products */}
                {user?.role === 'farmer' && product.farmer?._id === user?.id && (
